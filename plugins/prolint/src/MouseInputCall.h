...
namespace prolint {
	 ...
	 * TODO
	 */
	class MouseInputCall : public megamol::core::Call {
	...
	public:
        ...
        inline vislib::graphics::gl::CameraOpenGL GetCam(void) const { return this->cam; }
		...
		inline void SetCam(vislib::graphics::gl::CameraOpenGL& cam_tmp) {
	...
	typedef megamol::core::factories::CallAutoDescription<MouseInputCall> CallMouseInputDescription;
